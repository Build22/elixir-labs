defmodule Fib do
@moduledoc """
  Fibonacci Sequence, not efficient way
"""
  @seed [0, 1]
...
@moduledoc """
  Fibonacci Sequence, not efficient way,
  build the list backwards and reverse it at the end
"""
...
defmodule FibTest do
  ...
  test "benchmark" do
    ...
    {microsecs, _} = :timer.tc fn -> fib(1000) end # 8089
    IO.puts "fib() took #{microsecs} microsecs"

    {microsecs, _} = :timer.tc fn -> fib2(1000) end # 79
    IO.puts "fib2() took #{microsecs} in microsecs"
  end
